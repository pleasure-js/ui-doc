...
var vuedocParser = _interopDefault(require('@vuedoc/parser'));
...
async function parseUi (directory) {
  return Promise.map(await utils.deepScanDir(directory, { only: [/\.vue$/] }), async (filePath) => {
